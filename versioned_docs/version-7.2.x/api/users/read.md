...
keywords:
  ...
  - User
  - Read
description: Read OpenHIM Users via the API
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

To read existing user records you will need to make a TLS request to the OpenHIM API for the below method and endpoint.
...
```curl
./openhim-api.sh root@openhim.org openhim-password -v https://localhost:8080/users/userEmail
```

...
keywords:
  ...
  - Task
  - Delete
description: Delete an OpenHIM Task via the API
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

To delete a task record you will need to make a TLS request to the OpenHIM API for the below method and endpoint.
...
```curl
./openhim-api.sh root@openhim.org openhim-password -v -X DELETE https://localhost:8080/tasks/taskId
```

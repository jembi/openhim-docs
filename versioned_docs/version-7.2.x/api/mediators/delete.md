...
keywords:
  ...
  - Mediator
  - Delete
description: Delete an OpenHIM Mediator via the API
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

To delete a mediator, you will need to make a TLS request to the OpenHIM API for the below method and endpoint.

## Delete a specific mediator

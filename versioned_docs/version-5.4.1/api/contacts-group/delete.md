...
keywords:
  ...
  - Contact group
  - Delete
description: Delete an OpenHIM Contact group via the API
---
...
To delete a contact group record you will need to make a TLS request to the OpenHIM API for the below method and endpoint.
...
```curl
./openhim-api.sh root@openhim.org openhim-password -v -X DELETE https://localhost:8080/groups/groupId
```

...
<img alt="Mediator Details. Add Default Channel" src={useBaseUrl('img/tutorial/mediatorDetails.png')} />
...
<img alt="Channel Route Details" src={useBaseUrl('img/tutorial/routeDetails-after-v8.0.x.png')} />

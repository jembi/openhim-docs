...
keywords:
  ...
  - Client
  - Delete
description: Delete an OpenHIM Client via the API
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

To delete a client record you will need to make a TLS request to the OpenHIM API for the below method and endpoint.
...
```curl
./openhim-api.sh root@openhim.org openhim-password -v -X DELETE https://localhost:8080/clients/clientId
```

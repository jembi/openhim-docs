    ...
    >
      ...
      <div className="container margin-vert--xl" style={{textAlign: "center"}}>
        ...
        <div className="margin-bottom--lg">
          ...
          <p>Version 6 of the OpenHIM references a draft alpha release that is still in development. We will not be supporting documentation for this version until it is fully released.</p>
        </div>

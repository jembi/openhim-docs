...
const Index = () => {
  ...
  const Block = props => {
    return (
      ...
      >
        <div align="center" contents={props.children} layout={props.layout}>
          ...
          content: (
            <div>
              <p>
                ...
                <b>secure and view requests to your web service APIs</b>. It
                acts as a reverse proxy to your upstream services and while
                doing so enables visibility into your service-oriented
                architecture (SOA) by logging each request and by providing
                metrics about requests hitting your services. It also provides a
                central entry point into your SOA and allows you to secure
                access through mutual TLS or basic-auth.
              </p>
              <p>
                The OpenHIM is easy to install and can be easily configured to
                meet your needs through the administration console. You can also{' '}
                <b>
                  extend the OpenHIM to transform or orchestrate requests
                  through the mediator framework.
                </b>
              </p>
              <p>
                Plus, the OpenHIM is <b>open-source</b>! It is published under
                the{' '}
                ...
                <a href="http://www.ukzn.ac.za/">UKZN</a>. Browse the OpenHIM
                features below or get started right away.{' '}
          ...
          content: (
            <div>
              <p>
                ...
                implementation specific processing may occur. The OpenHIM has
                first class support for mediators through its mediator
                framework. This framework enables mediators to communicate with
                the OpenHIM-core to register themselves, log the processing that
                they do and even fetch user defined config.
              </p>
              <p>
                Check out the <a href="mediator-library">mediator library</a> to
                view mediators that have already been built. To learn more about
                creating your own mediators, see our{' '}
          ...
          content: (
            <div>
              <p>
                ...
                multiple upstream hosts based on a URL pattern. It also supports
                multicasting requests to multiple different routes.
              </p>
            </div>
          ),
      ...
      {[
        {
          content: (
            <div>
              <p>
                The O penHIM provides a secure interface to upstream hosts with
        ...
        {[
          {
            content: (
              <div>
                <p>
                  If you want to get involved in the development of the OpenHIM
                  then find us on{' '}
                  <a href="https://github.com/jembi/openhim-core-js">github</a>.
                  There you may submit issues if have any features request or
                  find any bugs. You may also submit pull requests for changes
                  that you\'d like to see and the maintainers will review them.
                </p>
                <p>
                  The OpenHIM is used in the OpenHIE project as a reference
                  implementation of an <b>interoperability layer</b>. Join the{' '}
                  <a href="https://wiki.ohie.org/display/SUB/Interoperability+Layer+Community">
                    interoperability community
                  </a>{' '}
                  or the{' '}
                  <a href="https://ohie.org/#involved">OpenHIE initiative</a> to
                  participate.
                </p>
              </div>
            ),
